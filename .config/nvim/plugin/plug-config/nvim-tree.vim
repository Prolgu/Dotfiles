...
highlight NvimTreeSymlink guifg=blue gui=bold,italic,underline
highlight NvimTreeFolderName guifg=Yellow gui=bold

highlight NvimTreeExecFile  guifg=Cyan gui=italic
"============================================================"
...
nnoremap <silent> <leader>rf :NvimTreeRefresh<CR>
