...
# open bookmarks
COMMANDS["Radio"]="alacritty --class Pyradio --title Pyradio -e pyradio -p 1"
LABELS["Radio"]=""

# search local files
COMMANDS["Htop"]="alacritty -e htop"
LABELS["Htop"]=""
...
# open custom web searches
COMMANDS["PowerOFF"]="shutdown -h now"
LABELS["PowerOFF"]=""
...
function start()
{
    ...
    print_menu | sort | rofi -dmenu -mesg "Scripts >>> " -i -p "Rofi-Launcher "
